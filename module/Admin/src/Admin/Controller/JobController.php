...
use Zend\Debug\Debug;
    ...
    class JobController extends JobeetController
    {
        ...
        public function editAction()
        {
            ...
            if ($request->isPost()) {
                ...
                if ($formJob->isValid()) {
                    ...
                    $this->flashMessenger()->addMessage(array('success' => "Job '{$job->id_job}' was updated successfully"));
        ...
        public function deleteAction()
        {
            ...
            $idJob = $this->params()->fromRoute('id', null);
            $nbResult = $this->jobTable->deleteJob(array('id_job = ?' => $idJob));
            
            if ($nbResult >= 1) {
                $this->flashMessenger()->addMessage(array('success' => "Job {$idJob} was deleted!"));
            } else {
                $this->flashMessenger()->addMessage(array('error' => "Job {$idJob} can't be deleted!"));
            }

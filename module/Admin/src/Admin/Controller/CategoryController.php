<?php
    ...
    class CategoryController extends JobeetController
    {
        ...
        public function deleteAction()
        {
            ...
            $idCategory = $this->params()->fromRoute('id', null);
            $nbResult = $this->categoryTable->deleteCategory(array('id_category = ?' => $idCategory));
            
            if ($nbResult >= 1) {
                $this->flashMessenger()->addMessage(array('success' => "Category {$idCategory} was deleted!"));
            } else {
                $this->flashMessenger()->addMessage(array('error' => "Category {$idCategory} can't be deleted!"));
            }
